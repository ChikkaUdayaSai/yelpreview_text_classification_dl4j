...
public class PrepareDataset {
	...
	public static void main(String[] args) {
		...
		int trainNum = (int) (countClassNum.get(0) * trainRatio );  // split trainset and testset
		...
		try {
			...
			try {
				...
				if(null!=bufferReader)bufferReader.close();
				if(null!=bfw1)bfw1.close();
				if(null!=bfw2)bfw2.close();
				if(null!=bfw3)bfw3.close();
				if(null!=bfw4)bfw4.close();
				if(null!=bfw5)bfw5.close();
				if(null!=bfw6)bfw6.close();
				if(null!=bfw7)bfw7.close();
				if(null!=bfw8)bfw8.close();
				if(null!=bfw9)bfw9.close();
				if(null!=bfw10)bfw10.close();
